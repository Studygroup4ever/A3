...
plot <- d %>% 
  ggplot(aes(x = Paper)) + 
  geom_point(aes(y = PitchMeanTD_Mean), color = 'royalblue') +
  geom_linerange(aes(ymin = PitchMeanTD_Mean - PitchMeanTD_SD, ymax = PitchMeanTD_Mean + PitchMeanTD_SD),
                 color = 'royalblue') +
  geom_point(aes(y = PitchMeanASD_Mean), shape = 1, color = 'firebrick') +
  geom_linerange(aes(ymin = PitchMeanASD_Mean - PitchMeanASD_SD, ymax = PitchMeanASD_Mean + PitchMeanASD_SD),
                 color = 'firebrick') + 
  theme(axis.text.x = element_text(angle = 60, hjust = 1))

...
```
you need prior from estimate, sd, 

intercept is mean of PV for controls
beta: diff of two groups (effect size)
compare analysis of skeptical priors and meta-analysis
